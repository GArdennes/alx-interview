...
However, you will lose points if you pick a cell too far from the cell that you picked in the previous row. For every two adjacent rows `r` and `r + 1` (where 0 $\leq$ r < m - 1), picking cells at coordinates (r, c<sub>1</sub>) and (r + 1, c<sub>2</sub>) will subtract abs(c<sub>1</sub> - c<sub>2</sub>) from your score.
...
You hadd 5 + 3 + 4 = 12 to your score.
...
* 1 $\leq$ m * n $\leq$ 10<sup>5</sup>
* 0 $\leq$ points[r][c] $\leq$ 10<sup>5</sup>